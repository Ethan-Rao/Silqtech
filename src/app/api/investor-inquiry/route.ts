...
export async function POST(request: NextRequest) {
  try {
    ...
    const { data, error } = await resend.emails.send({
      ...
      html: `
        ...
        <body>
          <div class="container">
            <div class="header">
              <h1 style="margin: 0; font-size: 20px;">New Investor Inquiry</h1>
              <p style="margin: 8px 0 0; opacity: 0.8; font-size: 14px;">From ${fullName} at ${organization}</p>
            </div>
            <div class="content">
              <div class="field">
    ...
    console.log('Investor inquiry email sent successfully:', data)
