  ...
  return (
    <header
      className={cn(
        ...
        'bg-silq-light border-b border-silq-dark/5 backdrop-blur-lg',
    ...
    >
            ...
            {navigation.map((item) => (
              ...
              >
                ...
                {item.children && (
                  ...
                  >
                    <div className="bg-silq-light rounded-xl shadow-xl shadow-silq-dark/10 border border-silq-dark/5 py-2 min-w-[220px]">
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-silq-light border-b border-silq-dark/10 shadow-lg">
